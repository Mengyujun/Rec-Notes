...
![[公式]](https://www.zhihu.com/equation?tex=%5Cfrac%7B1%7D%7BF1+%7D%3D%5Cfrac%7B2%7D%7B%5Cfrac%7B1%7D%7B%E7%B2%BE%E7%A1%AE%E5%BA%A6%7D%2B%5Cfrac%7B1%7D%7B%E5%8F%AC%E5%9B%9E%E7%8E%87%7D%7D)
...
对激活han函数进行**求导部分**大于1，那么层数增多的时候，最终的求出的梯度更新将以指数形式增加，即发生**梯度爆炸**，如果此部分小于1，那么随着层数增多，求出的梯度更新信息将会以指数形式衰减，即发生了**梯度消失**。
...
2. 本质原因是**反向传播的链式求导的连乘效应**，导致最后对权重的偏导接近于零。
